                ...
                <td className="p-4 text-right">
                  <div className="flex items-center justify-end gap-1">
                    <Link
                      ...
                      className="text-indigo-500 hover:text-indigo-600 transition-colors p-2 hover:bg-indigo-50 rounded-lg"
                    >
                    ...
                    <NoticeDeleteForm
                      ...
                      ariaLabel={`${notice.title} 삭제`}
                      buttonClassName="text-rose-500 hover:text-rose-600 transition-colors p-2 hover:bg-rose-50 rounded-lg"
                    >
