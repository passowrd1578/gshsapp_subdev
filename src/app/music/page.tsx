                           ...
                           <tr key={song.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                              ...
                              <td className="p-4 text-right">
                                 <div className="flex justify-end gap-1">
                                    {song.status === 'PENDING' && (
                                       <>
                                          ...
                                          <form action={updateSongStatus.bind(null, song.id, 'REJECTED')}>
                                             <button className="p-2 bg-rose-100 text-rose-600 rounded-lg hover:bg-rose-200"><X className="w-4 h-4" /></button>
                                          </form>
                                       </>
                                    )}
                                    ...
                                    {song.status === 'REJECTED' && <span className="text-xs text-rose-500 font-bold py-2">반려됨</span>}
                                 </div>
                              </td>
                           </tr>
                        ))}
